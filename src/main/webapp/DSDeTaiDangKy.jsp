...
<title>Danh sách đề tài đăng ký</title>
				...
				<div class="card-body p-4">
					<c:if test="${alert == null}">
						<h3 style="text-align: left"
							class="card-title fw-semibold mb-4 mt-5"
							style="margin-top: 200px">Chưa đến hạn đăng ký</h3>
					</c:if>
					<c:if test="${alert != null}">
						<h3 style="text-align: center"
							class="card-title fw-semibold mb-4 mt-5"
							style="margin-top: 200px">Danh Sách Đề Tài Đăng Ký</h3>
							...
							<table class="table text-nowrap mb-0 align-middle">
								<thead class="text-dark fs-4">
									<tr>
										...
										<th class="border-bottom-0">
											<h6 class="fw-semibold mb-0">Giáo viên hướng dẫn</h6>
										</th>
								...
								<tbody>
									...
									<c:forEach var="deTai" items="${listDeTai}">
										...
										<tr>
											...
											<td><a
												href="DeTai?action=showDangKyDeTai&MaDT=<c:out value="${deTai.getMaDT()}" />">Đăng
													Ký</a> <a
												href="DeTai?action=ChiTiet&MaDT=<c:out value="${deTai.getMaDT()}" />">Chi tiết</a></td>
										</tr>
									</c:forEach>
									<!-- } -->
								</tbody>
