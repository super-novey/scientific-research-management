...
<body>
					...
					<div class="row">
						<div class="container">
							<div class="card p-5">
								...
								<form
									action="DeTai?action=duyetDeTai&MaDT=<c:out value="${detai.getMaDT()}" />"
									method="post">
									<div class="row">
										<div class="col-sm-3">
											...
											<div class="col-sm-4">
												<div class="form-check">
													<input class="form-check-input" type="radio"
														onclick="hideLyDo()" name="duyet" id="duyet" value="1"
														checked> <label class="form-check-label"
														for="duyet">Duyệt</label>
												</div>
											</div>
											<div class="col-sm-4">
												<div class="form-check">
													<input class="form-check-input" type="radio"
														onclick="showLyDo()" name="duyet" id="khong-duyet"
														value="0"> <label class="form-check-label"
														for="khong-duyet">Không duyệt</label>
												</div>
											</div>
										</div>
									</div>
									<div class="form-group div-ly-do" style="display: none;">
										<label for="ly-do">Lý do:</label> <input type="text" name=LyDo
											class="form-control mt-4" id="ly-do" placeholder="Nhập lý do">
									</div>
									<div class="row mt-4">
	...
	<script src="assets/js/approval-topic.js"></script>
</body>
</html>
